...
func init() {
	...
	echoCmd.Flags().StringVar(&echoVersionFlag, "ver", "", "Show specific version or tag (uses default). Can also use name@version format")
	echoCmd.Flags().StringVar(&echoVersionFlag, "version", "", "Show specific version or tag (uses default) - alias for --ver")
